...
在当前产品结构中，主题风格不再直接暴露为“我的愿望”页头部的独立主功能，而是被收进右上角“设置”面板中的一个设置项。
...
### US-20｜通过设置进入角色选择与主题切换

**作为** 许愿池用户
**我想要** 从“我的愿望”页右上角进入设置，再选择不同的主题风格
**以便于** 在不打断愿望主流程的前提下，根据当前心境获得匹配的视觉体验和情绪陪伴

**业务规则与逻辑**：
1. 入口位置：我的愿望 Tab 右上角“设置”入口
2. 点击后先打开设置面板，其中包含“主题风格”设置项
3. 用户点击“主题风格”后，再弹出角色选择浮层，展示三个角色卡片
4. 每个角色卡片包含：头像、名称、一句话描述、预览色块
5. 用户点击任意角色卡片即刻切换主题
6. 主题切换后立即保存用户偏好，下次打开App保持选择

**验收标准**：
- [ ] 设置入口在我的愿望 Tab 右上角，图标清晰可见
- [ ] 设置面板中存在“主题风格”设置项
